...
- build(release): flutter/v0.1.0 [skip ci] (e668143)
- build(release): flutter/v0.1.0 [skip ci] (d386d2a)
- ci: update flutter coverage badge [skip ci] (d272af6)
...
- ci(flutter): run tests with coverage and publish a badge (c9479ed)
